...
export default function Home() {
  ...
  return (
    <main>
      <div className="mx-3">
        <Tabs aria-label="Pills" style="pills" className="justify-center gap-6">
          <Tabs.Item title="Lista de Contas">
            <Table>
              <Table.Head>
                <Table.Row>
      ...
      <Button color="secondary" size="little" onClick={singOut}>
        singOut
      </Button>
    </main>
  )
